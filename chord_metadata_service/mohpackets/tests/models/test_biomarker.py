...
class BiomarkerModelTest(TestCase):
    ...
    def test_fields(self):
        ...
        self.assertIsInstance(self.instance.psa_level, (float, type(None)))
        self.assertIsInstance(self.instance.ca125, (float, type(None)))
        self.assertIsInstance(self.instance.cea, (float, type(None)))
        self.assertIsInstance(self.instance.ca19_9, (float, type(None)))
