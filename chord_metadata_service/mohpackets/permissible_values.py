...
RadionuclideEnum = list_to_enum("RadionuclideEnum", RADIONUCLIDE)
DrugDoseUnitsEnum = list_to_enum("DrugDoseUnitsEnum", DRUG_DOSE_UNITS)
MassUnitUcumEnum = list_to_enum("MassUnitUcumEnum", MASS_UNIT_UCUM)
