...
This file was last generated on 2026-07-29 09:41:25. See README for how to regenerate.
...
classDiagram
    ...
    ca19_9 FloatField
    ca19_9_not_available BooleanField
    cea FloatField
  ...
  class Donor {
    ...
    date_of_death_is_estimated CharField
    date_resolution CharField
    gender CharField
    is_deceased CharField
    lost_to_follow_up CharField
  ...
  class Program {
    ...
    metadata JSONField
    pancan_cohort CharField
    pancan_id CharField
    participant_criteria TextField
  ...
  class RadiopharmaceuticalTherapy {
    agent_name CharField
    cumulative_drug_dose FloatField
    cumulative_drug_dose_not_available BooleanField
    donor_uuid ForeignKey
    drug_dose_units CharField
    end_date JSONField
    mass_unit_ucum CharField
    mass_value FloatField
    mass_value_not_available BooleanField
    number_of_cycles IntegerField
    number_of_cycles_not_available BooleanField
    program_id ForeignKey
    radionuclide CharField
    radionuclide_other CharField
    rxnorm_code CharField
