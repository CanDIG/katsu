This file is automatically generated using the `pyreverse` command from the `pylint` library, the `models.py` script and the `make_er_diagrams.py` script.

This file was last generated on 2023-10-18 17:29:07
