...
TREATMENT_SETTING = add_nulls(PERM_VAL.TREATMENT_SETTING)
ALL_TREATMENT_SETTING = [x for x in PERM_VAL.TREATMENT_SETTING if x != "Not available"]
...
MARGINS_STATUS = add_nulls(PERM_VAL.MARGINS_STATUS)
ALL_MARGINS_STATUS = [x for x in PERM_VAL.MARGINS_STATUS if x != "Not available"]
