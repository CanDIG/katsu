...
urlpatterns = [
    ...
    path('tables', views_search.table_list, name="katsu-table-list"),
    path('tables/<str:table_id>', views_search.table_detail, name="katsu-table-detail"),
    path('tables/<str:table_id>/summary', views_search.katsu_table_summary, name="table-summary"),
    path('tables/<str:table_id>/search', views_search.katsu_public_table_search, name="public-table-search"),
    path('search', views_search.katsu_search, name="search"),
    ...
    path('private/search', views_search.katsu_private_search, name="private-search"),
    path('private/tables/<str:table_id>/search', views_search.katsu_private_table_search, name="private-table-search"),
]
