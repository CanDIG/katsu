...
import katsu_service.katsu.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(blank=True, default=katsu_service.katsu.models.version_default, help_text='A release point for the dataset when applicable.', max_length=200)),
                ...
                ('has_part', models.ManyToManyField(blank=True, help_text="A Dataset that is a subset of this Dataset; Datasets declaring the 'hasPart' relationship are considered a collection of Datasets, the aggregation criteria could be included in the 'description' field.", related_name='_dataset_has_part_+', to='katsu.Dataset')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='table_ownership', to='katsu.Dataset')),
            ],
        ),
        migrations.CreateModel(
            name='Table',
            fields=[
                ('ownership_record', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='katsu.TableOwnership')),
        ...
        migrations.AddField(
            model_name='dataset',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='datasets', to='katsu.Project'),
        ),
    ]
